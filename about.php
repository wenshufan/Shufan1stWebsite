<?php include('includes/header.php');  ?>
  ...
  <article id="text"> <img class="headshot" src="Images/Shufan.jpg" alt="It is Shufan"/>
    <h2> About Me</h2>
    <p><strong> I want to be a unicorn!</strong></p>
    <p> I know it sounds crazy, but I really want to be a unicorn, and I am working toward it!</p>
    ...
    <ul>
      ...
      <li>Book: <a href="http://www.amazon.com/The-Journey-Seagulls-Turtles-Professionals/dp/3848421658/ref=sr_1_1?ie=UTF8&qid=1342122807&sr=8-1&keywords=shufan+wen"> The Journey of Seagulls and Sea Turtles: Chinese Professionals’ Experience in Suburban Metropolitan Philadelphia and Shanghai, China </a> 2012, Lambert Academic Publishing, 368 pp. </li>
      
    </ul><img class="small" src="Images/bookcover.jpg" alt="My book cover."/><img class="small" src="Images/articlecover.jpg" alt="My journal cover."/>
  ...
  <!-- Begin Sidebar -->
  <aside id= "sidebar">
    <h2 id="sub-navigation-title">About My Work</h2>
