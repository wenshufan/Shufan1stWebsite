...
<div id="navigation">
    ...
    <li <?php if ($page == 'portfolio.php'or'portfolioAmazon.php'or'portfolioGoogleCloud.php'or'portfolioUxpertise.php'or'portfolioTLR.php') { echo 'class="current"'; } ?>><a href="portfolio.php">Portfolio</a></li>
