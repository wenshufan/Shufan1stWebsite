...
{
	echo "<br>"."Even though you choose the subject as nothing important, I am still happy to hear from you!"."<br>";}
	
	elseif($subject=='Comment')
		{echo "<br>"."Any comment from you is truly appreciated! Thank you!"."<br>";}

}

else { 
	echo '<p> No junk email please. Thank you! </p>';
}
